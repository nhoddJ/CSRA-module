...
import metrics2,annotation_process
...
class CSRA_Trainer(object):
    ...
    def train(self, train_loader):
        ...
        for i, (input1, input2, filenames, targets) in enumerate(train_loader):
            ...
            if (i+1)%1==0:
                ...
                single_acc = metrics2.cal_acc_single(pm_target,pm_pred)
    ...
    def eval(self,val_loader):
        ...
        AUC = metrics2.cal_AUC(f_gt,f_pred)
        F1,N_F1 = metrics2.cal_F1(f_gt,f_pred)
        PPV,NPV = metrics2.cal_PV(f_gt,f_pred)
        ACC = metrics2.cal_ACC(f_gt,f_pred)
        vmix = (AUC+N_F1) / 2
